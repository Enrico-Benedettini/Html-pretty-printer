package src.tokenfactory.stringtokenfactory.operatortokenfactory;

import src.Token;
import src.tokenfactory.stringtokenfactory.StringTokenFactory;
...
public class OperatorTokenFactory extends StringTokenFactory {
    ...
    public Token getToken() {
        ...
        return new Token(tokenType, getTokenText());
    }
